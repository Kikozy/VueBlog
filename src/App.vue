...
<template>
  <div class="container">
    <nav class="global-navigation">
      <div class="nav-item">
        <img class="img-icon" src="@icon/post.svg" alt="icon-post" />
      </div>
      <div class="nav-item">
        <img class="img-icon" src="@icon/album.svg" alt="icon-album" />
      </div>
      <div class="nav-item">
        <img class="img-icon" src="@icon/link.svg" alt="icon-link" />
      </div>
      <div class="nav-item">
        <img class="img-icon" src="@icon/xiangji.svg" alt="icon-xiangji" />
      </div>
    </nav>
  ...
  .global-navigation {
    ...
    .nav-item {
      ...
      .img-icon {
		...
		&:hover {
          filter: invert(100%) sepia(100%) saturate(0%) hue-rotate(252deg) brightness(112%) contrast(101%);
        }
      }
    }
  }
